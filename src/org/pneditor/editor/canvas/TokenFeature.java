...
class TokenFeature implements Feature {
	...
	TokenFeature(final Canvas canvas) {
		...
		this.tokenCursor = GraphicsTools.getCursor("pneditor/canvas/token.gif", new Point(16, 0));
		this.fireCursor = GraphicsTools.getCursor("pneditor/canvas/fire.gif", new Point(16, 0));
	}
